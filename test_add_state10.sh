sed -i 's/pass 0i64;/pass 99i64;/g' src/regex_vm.npk
sed -i 's/int64:state = raw apop_state(work_ah);/int64:state = raw apop_state(work_ah);\npass 42i64;/g' src/regex_vm.npk
